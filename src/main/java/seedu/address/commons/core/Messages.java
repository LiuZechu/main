...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_STUDY_PLAN_DISPLAYED_INDEX = "The study plan index provided is invalid";
    ...
    public static final String MESSAGE_NO_STUDY_PLAN = "You don't have any study plan currently. Create now!";
